...
def main():
    ...
    app.add_access_point("Main Entrance", "A")
    app.add_access_point("Library", "B")
    app.add_access_point("Cafeteria", "C")
    app.add_access_point("Classroom Building", "D")

    # Adding routes
    app.add_route("Main Entrance", "Library", 1.5, "Bus", 1.00)
    app.add_route("Library", "Cafeteria", 0.8, "Walking", 0.00)
    app.add_route("Cafeteria", "Classroom Building", 2.0, "Bicycle", 0.50)
