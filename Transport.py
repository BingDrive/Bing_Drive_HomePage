...
class TransportationApp:
    ...
    def create_login_page(self):
        ...
        ttk.Label(self.login_frame, text="Name:").grid(row=1, column=0, sticky=tk.W, pady=5)
    ...
    def create_main_app(self):
        ...
        self.add_access_point("Main Entrance", "A")
        self.add_access_point("Library", "B")
        self.add_access_point("Cafeteria", "C")
        self.add_access_point("Classroom Building", "D")

        # Adding routes
        self.add_route("Main Entrance", "Library", 1.5, "Bus", 1.00)
        self.add_route("Library", "Cafeteria", 0.8, "Walking", 0.00)
        self.add_route("Cafeteria", "Classroom Building", 2.0, "Bicycle", 0.50)
        ...
        start_point_menu.set("Main Entrance")
    ...
    def calculate_cost_and_time(self):
        ...
        if route:
            ...
            distance_label.grid(row=6, column=0, columnspan=2, pady=5)

            estimated_time_label = ttk.Label(self.root, text=f"Estimated Time: {self.calculate_estimated_time(route.distance)} minutes")
            estimated_time_label.grid(row=7, column=0, columnspan=2, pady=5)
        else:
            ttk.Label(self.root, text="Route not found. Please check your input.").grid(row=5, column=0, columnspan=2, pady=5)
